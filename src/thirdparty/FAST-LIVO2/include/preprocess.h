...
#if __has_include(<livox_ros_driver/CustomMsg.h>) && !defined(FASTLIVO_FORCE_PORTABLE_TYPES)
#include <livox_ros_driver/CustomMsg.h>
#else
#include "fastlivo_port/vendor_compat.hpp"
#endif

#if __has_include(<pcl_conversions/pcl_conversions.h>) && !defined(FASTLIVO_FORCE_PORTABLE_TYPES)
