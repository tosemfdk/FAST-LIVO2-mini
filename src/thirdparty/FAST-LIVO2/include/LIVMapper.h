...
#if __has_include(<cv_bridge/cv_bridge.h>) && !defined(FASTLIVO_FORCE_PORTABLE_TYPES)
#include <cv_bridge/cv_bridge.h>
#endif

#if __has_include(<image_transport/image_transport.h>) && !defined(FASTLIVO_FORCE_PORTABLE_TYPES)
#include <image_transport/image_transport.h>
#else
#include "fastlivo_port/vendor_compat.hpp"
#endif

#if __has_include(<nav_msgs/Path.h>) && !defined(FASTLIVO_FORCE_PORTABLE_TYPES)
#include <nav_msgs/Path.h>
#else
#include "fastlivo_port/vendor_compat.hpp"
#endif

#if __has_include(<vikit/camera_loader.h>) && !defined(FASTLIVO_FORCE_PORTABLE_TYPES)
